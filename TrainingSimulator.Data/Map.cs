...
namespace TrainingSimulator.Data
{
    public class Map
    {
        ...
        {
            for(int r=0; r < RoomData.ROWS_OF_ROOMS; r++)
            {
                for(int c=0; c< RoomData.COLUMNS_OF_ROOMS; c++)
                {
        ...
        {
            MatchCollection matches = RoomData.namesRegex.Matches(roomData);
            if (matches.Count > 0)
            {
        ...
        {
            if (r >= 0 && r < RoomData.ROWS_OF_ROOMS && c >= 0 && c < RoomData.COLUMNS_OF_ROOMS)
            {
    ...
    {
        public const int ROWS_OF_ROOMS = 4;
        public const int COLUMNS_OF_ROOMS = 3;
